...
export default function Hero() {
    return (
        <section className="hero-wrapper">
            ...
            <div className="w-full h-[calc(100dvh-(120px))] relative overflow-hidden">
                <div className="w-6/12 h-full pl-54 flex flex-col justify-center gap-4">
                    ...
                    <button className="w-3/12 p-3 text-lg bg-[#0554f2] rounded text-white cursor-pointer">Saiba mais</button>
                </div>
            </div>
        </section>
    )
